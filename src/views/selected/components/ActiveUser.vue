<template>
    <div class="active-user">
        <div>
            ...
            <div style="width:100%;height:300px;" id="activeUserLine" v-show="tableShow"></div>
        ...
        <div style="width:100%;display:flex;">
            <div class="flex-a" style="width:60%;border-right: 1px solid #eee">
                <annular-percent name="PC" type="PC" :percent="insightData.type ? insightData.type[0].PC : 0" color="#5490d6"></annular-percent>
                <annular-percent name="Moblie" type="Moblie" :percent="insightData.type ? insightData.type[0].Mobile : 0" color="#e07d70"></annular-percent>
                <annular-percent name="WeChat" type="WeChat" :percent="insightData.type ? insightData.type[0].WeChat : 0" color="#5cc8a6"></annular-percent>
            </div>
            <div class="flex-a" style="width: 40%;border-right: 1px solid #eee">
                <annular-percent name="Male" type="Male" :percent="insightData.type ? insightData.type[0].boy : 0" color="#906f65"></annular-percent>
                <annular-percent name="Female" type="Female" :percent="insightData.type ? insightData.type[0].girl : 0" color="#dc6993"></annular-percent>
            </div>
